import { ChevronDown, LayoutDashboard, Rocket } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-[#070707] text-white">
      <div className="flex min-h-screen w-full flex-col gap-2 p-2">
        ...
        <div className="grid flex-1 gap-2 lg:grid-cols-[280px_minmax(0,1fr)]">
          <aside className="rounded-[12px] border border-white/10 bg-white/5 shadow-[0_0_0_1px_rgba(255,255,255,0.02),0_24px_80px_rgba(0,0,0,0.45)]" />
          <main className="rounded-[12px] border border-white/10 bg-white/5 shadow-[0_0_0_1px_rgba(255,255,255,0.02),0_24px_80px_rgba(0,0,0,0.45)]" />
        </div>
      </div>
    </div>
  )
